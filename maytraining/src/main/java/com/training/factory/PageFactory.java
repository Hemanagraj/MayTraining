...
public class PageFactory {
	...
	public static SalesForceBasePage initialize(String pageName) {
		...
		try {
			...
			if (packageName != null) {
				...
				page = (SalesForceBasePage) Class.forName(pageClassFullName).newInstance();
			} else {
				System.out.println(
	...
	private static String getRemovedSpaceName(String pageName) {
